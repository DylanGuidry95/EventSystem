...
public class Observer : Singleton<Observer> 
{
    ...
    {
        Debug.Log(msg); //displays the msg/event to the console
    ...
    private void NotifySubs(string msg)
    {
        ...
        {
            if (Subscribers.ContainsKey(msg)) //if the disctionary for subribers contains the msg
            {
                s.Value.Recive(msg); // the subscriber will then recive the msg
            }
        }
    }
    ...
    static public void AddSub(string type, string msg, ISub sub)
    {
        ...
        instance.AddListener(subcription, sub);
    }
